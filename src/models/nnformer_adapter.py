"""nnFormer model adapted for DG-CMFNet framework.

All nnFormer building blocks are copied from nnFormer_tumor.py and made
standalone (nn.Module-based, no nnUNet / nnformer pipeline dependencies).
"""
...
# =========================================================================
# Low-level utilities (kept from nnFormer_tumor.py)
# =========================================================================
...
def window_reverse(windows, window_size, S, H, W):
    ...
    x = windows.view(
        B, S // window_size, H // window_size, W // window_size, window_size, window_size, window_size, -1
    )
...
# =========================================================================
# Attention & Swin Transformer blocks
# =========================================================================
...
# =========================================================================
# nnFormer model (standalone, nn.Module-based)
# =========================================================================


class NnFormerModel(nn.Module):
    """Standalone nnFormer model, adapted from nnFormer_tumor.py.

    Inherits from nn.Module directly (not SegmentationNetwork) to avoid
    nnUNet pipeline dependencies.
    """
...
# =========================================================================
# DG-CMFNet ModelAdapter wrapper
# =========================================================================


class NnFormerAdapter(nn.Module):
    """Adapter that wraps nnFormer for the DG-CMFNet framework.

    Conforms to the ModelAdapter protocol: forward(batch) -> ModelOutput.
    Expects batch["signal"] of shape [B, M, D, H, W] and treats modalities
    as input channels (i.e. [B, M, D, H, W] -> [B, M, D, H, W] directly,
    which nnFormer interprets as C-channel 3D input).
    """
    ...
    def __init__(
        ...
        window_size: tuple[int, int, int, int] = (4, 4, 8, 4),
